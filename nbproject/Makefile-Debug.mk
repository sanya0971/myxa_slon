...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/test.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} ../googletest/dist/Debug/GNU-MacOSX/libgoogletest.a 


${TESTDIR}/test.o: test.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../Downloads/gtest-1.7.0 -I../../Downloads/gtest-1.7.0/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/test.o test.cpp


${OBJECTDIR}/Solution_nomain.o: ${OBJECTDIR}/Solution.o Solution.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/Solution.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Solution_nomain.o Solution.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/Solution.o ${OBJECTDIR}/Solution_nomain.o;\
	fi
